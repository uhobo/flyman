...
export class DiagramChart implements ChartData {
 ...
 export class ChartRequet{
    constructor(public fileDataId?: string, public chartType?: number, public selectedSubject?:number, 
      public includeAverage?:boolean,  public includeMedian?:boolean, public chartByGroup?: boolean, 
      public distrubution?: boolean, public selectXnodes?: TreeNode[],  public selectYnodes?: TreeNode[]) {}
 }
