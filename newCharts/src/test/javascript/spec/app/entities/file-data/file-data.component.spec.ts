...
import { FileDataComponent } from 'app/entities/file-data/file-data.component';
...
describe('Component Tests', () => {
  describe('FileData Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.fileData[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
