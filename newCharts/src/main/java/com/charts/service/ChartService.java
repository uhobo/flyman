...
public class ChartService {
	...
	public ChartService(FileDataRepository fileDataRepository, FileDataService fileDataService) {
		this.fileDataRepository = fileDataRepository;
		this.fileDataService = fileDataService;
	}
	
	public Optional<List<TreeNode>> createTreeTable(String id, Integer subjectType) throws JsonProcessingException {
		...
		return Optional.ofNullable(fileDataService.createTreeMenu(fileData.get(), subject));
	}
