...
import { IAttributeType } from 'app/shared/model/attributeType.model';
...
export class AttributeService {
    ...
    public resourceAttributeTypeUrl = SERVER_API_URL + 'api/attributeTypes';
    ...
    queryAttributeTypes(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IAttributeType[]>(this.resourceAttributeTypeUrl, { params: options, observe: 'response' });
    }
}
