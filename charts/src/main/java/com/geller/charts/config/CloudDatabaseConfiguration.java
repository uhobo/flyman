package com.geller.charts.config;
...
@Configuration
@EnableMongoRepositories("com.geller.charts.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.geller.charts.config.dbmigrations");
