...
public class PersonResourceIntTest {
    ...
    public void createPerson() throws Exception {
        ...
        // Create the Person
        restPersonMockMvc.perform(post("/api/people/createPerson")
        ...
        assertThat(testPerson.getInternalId()).isEqualTo(DEFAULT_INTERNAL_ID);
    ...
    public void updatePerson() throws Exception {
        ...
        Person testPerson = personList.get(personList.size() - 1);
        assertThat(testPerson.getInternalId()).isEqualTo(UPDATED_INTERNAL_ID);
