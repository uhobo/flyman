...
describe('Service Tests', () => {
    describe('Attribute Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Attribute('ID', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Attribute', async () => {
            ...
            it('should update a Attribute', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        value: 'BBBBBB'
            ...
            it('should return a list of Attribute', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        value: 'BBBBBB'
